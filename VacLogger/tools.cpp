...
int ModuleIndexFromPtr(void* ScanRegion)
{
    ...
    */
    ...
    constexpr std::string_view ModuleSigs[] =
    {
        ...
        "6A 68 88 44 24 49 88 44 24 50 88 44 24 28 88 44 24 2E 88 44 24 3A 88 44 24 40 58 6A 36 66 89 44 24 70 58",    // 4  - MapViewOfFile calls (seems to be unused)
        ...
        "6A 0E 66 89 44 24 62 58 66 89 44 24 5C 8D 44 24 5C 89 84 24 80 00 00 00 8D 44 24 78 50 68 01 00 02 00 8D 44", // 11 - NtQueryDirectoryObject (driver enumeration)
